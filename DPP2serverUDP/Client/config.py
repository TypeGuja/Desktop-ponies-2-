    ...
    def load(self):
        ...
        default_config = {
            ...
            'network': {
                ...
                'default_port': 5555,
                'timeout': 2.0,  # <-- Уменьшен для UDP
                'reconnect_attempts': 3,
                'udp_max_packet_size': 1400,  # <-- Новый параметр для UDP
                'udp_heartbeat_interval': 1.0,  # <-- Интервал heartbeat
                'udp_position_update_rate': 0.016  # <-- Частота обновления позиции
            },
            'game': {
