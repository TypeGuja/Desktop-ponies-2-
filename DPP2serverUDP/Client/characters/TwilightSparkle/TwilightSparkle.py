...
class GIFPlayer:
    def __init__(self, root, initial_scale=1.0):
        ...
        self.GIF_FOLDER = os.path.join(current_dir, "Twilight Sparkle_Gifct")

        # ========== ПУТИ ДЛЯ ГИФОК ==========
        self.GIF_PATHS = {
            # Stand гифки
            "stand_right": "stand_ts_right.gif",
            "stand_left": "stand_ts_left.gif",

            # Movement гифки
            "move_right": "trotcycle_ts_right.gif",
            "move_left": "trotcycle_ts_left.gif",

            # Sleep гифки (в подпапке sleep-ts)
            "sleep_right": os.path.join("sleep-ts", "read.gif"),
            "sleep_left": "none",

            # Drag гифки (в подпапке drag-ts)
            "drag": os.path.join("drag-ts", "ts_drag_left.gif")
        }
    ...
    def _go_to_sleep(self):
        ...
        print("😴 Twilight Sparkle засыпает")
    ...
    def _wake_up(self):
        ...
        print("🌅 Twilight Sparkle просыпается")
        self.is_sleeping = False
        self.moving = True
    ...
    def _check_gif_folder(self):
        ...
        if not os.path.exists(self.GIF_FOLDER):
            ...
            try:
                ...
                print("✅ Папка создана")
                sleep_folder = os.path.join(self.GIF_FOLDER, "sleep-ts")
                drag_folder = os.path.join(self.GIF_FOLDER, "drag-ts")
    ...
    def _exit_program(self):
        ...
        print("🛑 Завершение программы через Twilight Sparkle...")
        self._stop_all_threads()
        self._clear_canvas_completely()
        import sys
        sys.exit(0)
    ...
    def _create_fallback_animation(self):
        ...
        try:
            ...
            for i, color in enumerate(colors):
                ...
                draw.text((center_x - 10, center_y - 5), "TS", fill="white")
    ...
    def _stop_all_threads(self):
        ...
        print("🛑 Мягкая остановка потоков Twilight Sparkle...")
