...
class GIFPlayer:
    def __init__(self, root, initial_scale=1.0):
        ...
        self.GIF_FOLDER = os.path.join(current_dir, "Luna_Gifct")

        # ========== ПУТИ ДЛЯ ГИФОК ==========
        self.GIF_PATHS = {
            # Stand гифки
            "stand_right": "luna_idle_right.gif",
            "stand_left": "luna_idle_left.gif",

            # Movement гифки
            "move_right": "luna_walk_right.gif",
            "move_left": "luna_walk_left.gif",
        ...
        self.base_sleep_width = 160
        self.base_sleep_height = 160
        ...
        self.FRAME_DURATION_MS = 90 #90
        self.SLEEP_FRAME_DURATION_MS = 700
        self.MOVE_INTERVAL_MIN = 3 #2
        self.MOVE_INTERVAL_MAX = 15 #5
        self.MOVE_SPEED_PX_PER_STEP = max(1, int(2 * self.current_scale))  # Масштабируем скорость 2
        ...
        self.PUSH_ZONE_SIZE = int(1 * self.current_scale)  # Размер зоны выталкивания (px) с масштабом
        self.PUSH_FORCE = int(5 * self.current_scale)  # Сила выталкивания (px) с масштабом
    ...
    def change_scale(self, new_scale):
        ...
        try:
            ...
            print(f"📏 Изменение масштаба на {scale_percent}%")
    ...
    # ========== ОСТАЛЬНЫЕ МЕТОДЫ (с обновлениями для масштабирования) ==========
    ...
    def _exit_program(self):
        ...
        print("🛑 Завершение программы через Luna...")
        self._stop_all_threads()
        self._clear_canvas_completely()
        import sys
        sys.exit(0)
    ...
    def _create_fallback_animation(self):
        ...
        try:
            ...
            for i, color in enumerate(colors):
                ...
                draw.text((center_x - 10, center_y - 5), "Luna", fill="white")
    ...
    def _stop_all_threads(self):
        ...
        print("🛑 Мягкая остановка потоков Luna...")
