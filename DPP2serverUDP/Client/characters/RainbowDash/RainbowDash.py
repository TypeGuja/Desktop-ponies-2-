...
class GIFPlayer:
    def __init__(self, root, initial_scale=1.0):
        ...
        self.GIF_FOLDER = os.path.join(current_dir, "Rainbow Dash_Gifct")

        # ========== ПУТИ ДЛЯ ГИФОК ==========
        self.GIF_PATHS = {
            # Stand гифки
            "stand_right": "stand_rd_right.gif",
            "stand_left": "stand_rd_left.gif",

            # Movement гифки
            "move_right": "trotcycle_rd_wing_right.gif",
            "move_left": "trotcycle_rd_wing_left.gif",

            # Sleep гифки
            "sleep_right": os.path.join("sleep-rd", "cloud_sleep_right.gif"),
            "sleep_left": os.path.join("sleep-rd", "cloud_sleep_left.gif"),

            # Drag гифки
            "drag": os.path.join("drag-rd", "rd_drag_left.gif")
        }
    ...
    def _wake_up(self):
        ...
        print("🌅 Rainbow Dash просыпается")
        self.is_sleeping = False
        self.moving = True
    ...
    def _check_gif_folder(self):
        ...
        if not os.path.exists(self.GIF_FOLDER):
            ...
            try:
                ...
                print("✅ Папка создана")
                sleep_folder = os.path.join(self.GIF_FOLDER, "sleep-rd")
                drag_folder = os.path.join(self.GIF_FOLDER, "drag-rd")
    ...
    def _exit_program(self):
        ...
        print("🛑 Завершение программы через Rainbow Dash...")
        self._stop_all_threads()
        self._clear_canvas_completely()
        import sys
        sys.exit(0)
    ...
    def _create_fallback_animation(self):
        ...
        try:
            ...
            for i, color in enumerate(colors):
                ...
                draw.text((center_x - 10, center_y - 5), "RD", fill="white")
    ...
    def _stop_all_threads(self):
        ...
        print("🛑 Мягкая остановка потоков Rainbow Dash...")
