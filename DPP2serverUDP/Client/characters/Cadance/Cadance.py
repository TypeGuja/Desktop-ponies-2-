...
class GIFPlayer:
    def __init__(self, root, initial_scale=1.0):
        ...
        self.base_sleep_width = 150
        self.base_sleep_height = 150
    ...
    def change_scale(self, new_scale):
        ...
        try:
            ...
            print(f"📏 Cadance: Изменение масштаба на {scale_percent}%")
            ...
            print(f"✅ Cadance: Масштаб изменен на {self.WIDTH}x{self.HEIGHT}")
            return True

        except Exception as e:
            print(f"❌ Cadance: Ошибка изменения масштаба: {e}")
            return False
        ...
        try:
            if self.current_gif_path and os.path.exists(self.current_gif_path):
                ...
                if frames:
                    self.frames = frames
                    self.frame_index = 0
                    print(f"✅ Cadance: Гифка перезагружена с размером {target_width}x{target_height}")
                else:
                    print("⚠️ Cadance: Не удалось перезагрузить гифку")
        except Exception as e:
            print(f"❌ Cadance: Ошибка перезагрузки гифки: {e}")
    ...
    def _load_gif_specific_size(self, path, target_width, target_height):
        ...
        try:
            ...
            print(f"Cadance: Ошибка загрузки GIF: {e}")
        return frames
    ...
    def _check_and_push_from_edges(self):
        ...
        try:
            ...
            if not self._shutdown_flag.is_set():
                print(f"❌ Cadance: Ошибка при выталкивании: {e}")
    ...
    def _safe_move_to_target(self):
        ...
        while (self.moving and not self.is_dragging and
            ...
            try:
                ...
                print(f"Cadance: Ошибка в движении: {e}")
                break
    ...
    def _check_gif_folder(self):
        ...
        if not os.path.exists(self.GIF_FOLDER):
            try:
                ...
                print(f"❌ Cadance: Ошибка создания папки: {e}")
    ...
    def _create_fallback_animation(self):
        ...
        try:
            ...
            for color in colors:
                ...
                draw.text((center_x - 20, center_y - 10), "Cadance", fill="white")
            ...
            print(f"❌ Cadance: Ошибка создания fallback анимации: {e}")
            return False
    ...
    def _load_any_gif(self):
        ...
        try:
            ...
            print(f"❌ Cadance: Ошибка при поиске гифок: {e}")
    ...
    def _clear_canvas_completely(self):
        ...
        try:
            ...
            print(f"Cadance: Ошибка при очистке canvas: {e}")
    ...
    def _toggle_sleep_wake(self):
        ...
        if self.is_sleeping:
            print("🌅 Cadance: Принудительное пробуждение")
            self._forced_sleep = False
            self._wake_up()
        else:
            print("💤 Cadance: Принудительный переход в сон")
    ...
    def _create_sleep_fallback(self):
        ...
        try:
            ...
            print(f"❌ Cadance: Ошибка создания sleep fallback: {e}")
