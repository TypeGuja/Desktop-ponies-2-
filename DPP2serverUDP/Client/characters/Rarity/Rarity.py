...
class GIFPlayer:
    def __init__(self, root, initial_scale=1.0):
        ...
        self.GIF_FOLDER = os.path.join(current_dir, "Rarity_Gifct")

        # ========== ПУТИ ДЛЯ ГИФОК ==========
        self.GIF_PATHS = {
            # Stand гифки
            "stand_right": "stand_r_right.gif",
            "stand_left": "stand_r_left.gif",

            # Movement гифки
            "move_right": "trotcycle_r_right.gif",
            "move_left": "trotcycle_r_left.gif",

            # Sleep гифки (в подпапке sleep-rt)
            "sleep_right": os.path.join("sleep-rt", "sleep_right.gif"),
            "sleep_left": os.path.join("sleep-rt", "sleep_left.gif"),

            # Drag гифки (в подпапке drag-rt)
            "drag": os.path.join("drag-rt", "rt_drag-left.gif")
        }
    ...
    def change_scale(self, new_scale):
        ...
        try:
            ...
            print(f"📏 Изменение масштаба Rarity на {scale_percent}%")
    ...
    def _check_gif_folder(self):
        ...
        if not os.path.exists(self.GIF_FOLDER):
            ...
            try:
                ...
                print("✅ Папка создана")
                sleep_folder = os.path.join(self.GIF_FOLDER, "sleep-rt")
                drag_folder = os.path.join(self.GIF_FOLDER, "drag-rt")
    ...
    def _exit_program(self):
        ...
        print("🛑 Завершение программы через Rarity...")
        self._stop_all_threads()
        self._clear_canvas_completely()
        import sys
        sys.exit(0)
    ...
    def _create_fallback_animation(self):
        ...
        try:
            ...
            for i, color in enumerate(colors):
                ...
                draw.text((center_x - 10, center_y - 5), "R", fill="white")
    ...
    def _stop_all_threads(self):
        ...
        print("🛑 Мягкая остановка потоков Rarity...")
